...
<body>
	<div class="container">
		...
		<div class="dashboard-content">
            ...
            <form action="${pageContext.request.contextPath}/teacher/updateSchoolInfo" method="post" onsubmit="return confirmSubmit()">
		    ...
		    <div class="form-group">
		        ...
		        <input type="text" name="addressI" value="${school.addressI}">
		    </div>
		    <div class="form-group">
		        <label for="addressII">Address II</label>
		        <input type="text" name="addressII" value="${school.addressII}">
		    </div>
		    <div class="form-group">
		        <label for="phoneNo">Phone No</label>
		        <input type="text" name="phoneNo" value="${school.phoneNo}">
		    </div>
		    <div class="form-group">
		    ...
		    <div class="form-group">
		        ...
		        <input type="text" name="postcode" value="${school.postcode}">
		    </div>
		    <div class="form-group">
		    ...
		    <div class="form-group">
		        ...
		        <input type="text" name="faxNo" value="${school.faxNo}">
		    </div>
		    <div class="form-group">
		    ...
		    <div class="form-group">
		        ...
		        <div class="video-container">
		            <c:if test="${school.videoLink != null}">
		                <input type="text" name="videoLink" value="${school.videoLink}">
		            </c:if>
		            <c:if test="${school.videoLink == null}">
			...
			<button type="submit" class="submit-btn">Save</button>
		        <button type="button" class="submit-btn" onclick="window.location.href='${pageContext.request.contextPath}/teacher/viewSchoolInfo?id=${school.id}'">Back</button>
		    </div>
		</form>
        </div>
    </div>
